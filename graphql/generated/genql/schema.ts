...
export interface MutationRequest{
    createGoal?: [{description: Scalars['String'],estimate?: (GoalEstimate | null),key?: (Scalars['Boolean'] | null),ownerId: Scalars['String'],personal?: (Scalars['Boolean'] | null),private?: (Scalars['Boolean'] | null),projectId: Scalars['Int'],stateId?: (Scalars['String'] | null),title: Scalars['String'],user: UserSession},GoalRequest]
    createProject?: [{description?: (Scalars['String'] | null),flowId: Scalars['String'],ownerId: Scalars['String'],title: Scalars['String'],user: UserSession},ProjectRequest]
...
export interface FlowPromiseChain{
    graph: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Promise<Scalars['ID']>}),
    ...
    states: ({get: <R extends StateRequest>(request: R, defaultValue?: ((FieldsSelection<State, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<State, R> | undefined)[] | undefined)>}),
    title: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Promise<Scalars['String']>})
}

export interface FlowObservableChain{
    graph: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Observable<Scalars['ID']>}),
    ...
    states: ({get: <R extends StateRequest>(request: R, defaultValue?: ((FieldsSelection<State, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<State, R> | undefined)[] | undefined)>}),
...
export interface GoalPromiseChain{
    ...
    issuerId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    ...
    ownerId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    ...
    projectId: ({get: (request?: boolean|number, defaultValue?: (Scalars['Int'] | undefined)) => Promise<(Scalars['Int'] | undefined)>}),
    ...
    stateId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    title: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Promise<Scalars['String']>}),
    updatedAt: ({get: (request?: boolean|number, defaultValue?: Scalars['DateTime']) => Promise<Scalars['DateTime']>})
}
...
export interface GoalObservableChain{
    ...
    issuerId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    ...
    ownerId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    ...
    projectId: ({get: (request?: boolean|number, defaultValue?: (Scalars['Int'] | undefined)) => Observable<(Scalars['Int'] | undefined)>}),
    ...
    stateId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    title: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Observable<Scalars['String']>}),
    updatedAt: ({get: (request?: boolean|number, defaultValue?: Scalars['DateTime']) => Observable<Scalars['DateTime']>})
}

export interface MutationPromiseChain{
    createGoal: ((args: {description: Scalars['String'],estimate?: (GoalEstimate | null),key?: (Scalars['Boolean'] | null),ownerId: Scalars['String'],personal?: (Scalars['Boolean'] | null),private?: (Scalars['Boolean'] | null),projectId: Scalars['Int'],stateId?: (Scalars['String'] | null),title: Scalars['String'],user: UserSession}) => GoalPromiseChain & {get: <R extends GoalRequest>(request: R, defaultValue?: (FieldsSelection<Goal, R> | undefined)) => Promise<(FieldsSelection<Goal, R> | undefined)>}),
    createProject: ((args: {description?: (Scalars['String'] | null),flowId: Scalars['String'],ownerId: Scalars['String'],title: Scalars['String'],user: UserSession}) => ProjectPromiseChain & {get: <R extends ProjectRequest>(request: R, defaultValue?: (FieldsSelection<Project, R> | undefined)) => Promise<(FieldsSelection<Project, R> | undefined)>}),
...
export interface MutationObservableChain{
    createGoal: ((args: {description: Scalars['String'],estimate?: (GoalEstimate | null),key?: (Scalars['Boolean'] | null),ownerId: Scalars['String'],personal?: (Scalars['Boolean'] | null),private?: (Scalars['Boolean'] | null),projectId: Scalars['Int'],stateId?: (Scalars['String'] | null),title: Scalars['String'],user: UserSession}) => GoalObservableChain & {get: <R extends GoalRequest>(request: R, defaultValue?: (FieldsSelection<Goal, R> | undefined)) => Observable<(FieldsSelection<Goal, R> | undefined)>}),
    createProject: ((args: {description?: (Scalars['String'] | null),flowId: Scalars['String'],ownerId: Scalars['String'],title: Scalars['String'],user: UserSession}) => ProjectObservableChain & {get: <R extends ProjectRequest>(request: R, defaultValue?: (FieldsSelection<Project, R> | undefined)) => Observable<(FieldsSelection<Project, R> | undefined)>}),
...
export interface ProjectPromiseChain{
    ...
    flow: (FlowPromiseChain & {get: <R extends FlowRequest>(request: R, defaultValue?: (FieldsSelection<Flow, R> | undefined)) => Promise<(FieldsSelection<Flow, R> | undefined)>}),
...
export interface ProjectObservableChain{
    ...
    flow: (FlowObservableChain & {get: <R extends FlowRequest>(request: R, defaultValue?: (FieldsSelection<Flow, R> | undefined)) => Observable<(FieldsSelection<Flow, R> | undefined)>}),
...
export interface QueryPromiseChain{
    ...
    flow: ((args: {id: Scalars['String']}) => FlowPromiseChain & {get: <R extends FlowRequest>(request: R, defaultValue?: (FieldsSelection<Flow, R> | undefined)) => Promise<(FieldsSelection<Flow, R> | undefined)>}),
    flowCompletion: ((args: {query: Scalars['String'],sortBy?: (SortOrder | null)}) => {get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    flowRecommended: ({get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    ...
    projectCompletion: ((args: {query: Scalars['String'],sortBy?: (SortOrder | null)}) => {get: <R extends ProjectRequest>(request: R, defaultValue?: ((FieldsSelection<Project, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<Project, R> | undefined)[] | undefined)>}),
...
export interface QueryObservableChain{
    ...
    flow: ((args: {id: Scalars['String']}) => FlowObservableChain & {get: <R extends FlowRequest>(request: R, defaultValue?: (FieldsSelection<Flow, R> | undefined)) => Observable<(FieldsSelection<Flow, R> | undefined)>}),
    flowCompletion: ((args: {query: Scalars['String'],sortBy?: (SortOrder | null)}) => {get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    flowRecommended: ({get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    ...
    projectCompletion: ((args: {query: Scalars['String'],sortBy?: (SortOrder | null)}) => {get: <R extends ProjectRequest>(request: R, defaultValue?: ((FieldsSelection<Project, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<Project, R> | undefined)[] | undefined)>}),
...
export interface StatePromiseChain{
    default: ({get: (request?: boolean|number, defaultValue?: (Scalars['Boolean'] | undefined)) => Promise<(Scalars['Boolean'] | undefined)>}),
    flows: ({get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Promise<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Promise<Scalars['ID']>}),
    title: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Promise<Scalars['String']>})
}

export interface StateObservableChain{
    default: ({get: (request?: boolean|number, defaultValue?: (Scalars['Boolean'] | undefined)) => Observable<(Scalars['Boolean'] | undefined)>}),
    flows: ({get: <R extends FlowRequest>(request: R, defaultValue?: ((FieldsSelection<Flow, R> | undefined)[] | undefined)) => Observable<((FieldsSelection<Flow, R> | undefined)[] | undefined)>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Observable<Scalars['ID']>}),
    title: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Observable<Scalars['String']>})
}
...
export interface UserPromiseChain{
    activity: (ActivityPromiseChain & {get: <R extends ActivityRequest>(request: R, defaultValue?: (FieldsSelection<Activity, R> | undefined)) => Promise<(FieldsSelection<Activity, R> | undefined)>}),
    activityId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Promise<(Scalars['String'] | undefined)>}),
    createdAt: ({get: (request?: boolean|number, defaultValue?: Scalars['DateTime']) => Promise<Scalars['DateTime']>}),
    email: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Promise<Scalars['String']>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Promise<Scalars['ID']>}),
...
export interface UserObservableChain{
    activity: (ActivityObservableChain & {get: <R extends ActivityRequest>(request: R, defaultValue?: (FieldsSelection<Activity, R> | undefined)) => Observable<(FieldsSelection<Activity, R> | undefined)>}),
    activityId: ({get: (request?: boolean|number, defaultValue?: (Scalars['String'] | undefined)) => Observable<(Scalars['String'] | undefined)>}),
    createdAt: ({get: (request?: boolean|number, defaultValue?: Scalars['DateTime']) => Observable<Scalars['DateTime']>}),
    email: ({get: (request?: boolean|number, defaultValue?: Scalars['String']) => Observable<Scalars['String']>}),
    id: ({get: (request?: boolean|number, defaultValue?: Scalars['ID']) => Observable<Scalars['ID']>}),
